    ...
    <section ref={sectionRef} className="bg-primary2 relative py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className={`text-center mb-12 md:mb-16 transition-all duration-1000 ${
          ...
          <p className="text-lg md:text-xl text-primary max-w-3xl mx-auto leading-relaxed px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center max-w-7xl mx-auto">
          ...
          <div className={`relative transition-all duration-1000 ${
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl w-full max-w-[480px] h-auto mx-auto">
              <img 
          ...
          <div className="space-y-6 md:space-y-8">
            {stats.map((stat, index) => (
              <div 
                key={index} 
                className={`flex items-center space-x-4 md:space-x-6 p-4 rounded-xl bg-white/80 hover:shadow-lg transition-all duration-700 hover:bg-white/50 hover:shadow-lg group ${
                  isVisible 
              ...
              >
                ...
                <div className="flex-shrink-0">
                  <h3 className="text-3xl sm:text-4xl md:text-5xl xl:text-5xl font-black bg-primary/75 bg-clip-text text-transparent leading-none group-hover:scale-105 transition-transform duration-300">
                ...
                <div className="flex-grow">
                  <h4 className="text-lg md:text-xl font-bold text-gray-800 mb-1 md:mb-2 group-hover:text-gray-900 transition-colors duration-300">
                    {stat.label}
                  </h4>
